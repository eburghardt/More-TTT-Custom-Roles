...
function CORPSE.ShowSearch(ply, rag, covert, long_range)
	...
	if (ply:IsActiveDetective() or ply:IsActiveTraitor() or ply:IsActiveMercenary() or ply:IsActiveZombie() or ply:IsActiveVampire() or ply:IsActiveHypnotist() or ply:IsActiveAssassin() or ply:IsActiveKiller() or ply:IsActiveDoctor() or ply:IsActiveCursed() or ply:IsActiveDetraitor()) and credits > 0 and (not long_range) then
