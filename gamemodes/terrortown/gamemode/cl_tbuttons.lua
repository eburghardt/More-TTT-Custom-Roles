...
function TBHUD:CacheEnts()
	if IsValid(LocalPlayer()) and (LocalPlayer():IsActiveTraitor() or LocalPlayer():IsActiveHypnotist() or LocalPlayer():IsActiveVampire() or LocalPlayer():IsActiveCursed() or LocalPlayer():IsActiveAssassin() or LocalPlayer():IsActiveZombie()) then
		self.buttons = {}
...
function TBHUD:PlayerIsFocused()
	return IsValid(LocalPlayer()) and (LocalPlayer():IsActiveTraitor() or LocalPlayer():IsActiveHypnotist() or LocalPlayer():IsActiveVampire() or LocalPlayer():IsActiveCursed() or LocalPlayer():IsActiveAssassin() or LocalPlayer():IsActiveZombie()) and IsValid(self.focus_ent)
end
