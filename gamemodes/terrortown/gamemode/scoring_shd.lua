...
function ScoreEventLog(events, scores, traitors, detectives, hypnotists, mercenaries, jesters, phantoms, glitches, zombies, vampires, swappers, assassins, killers, doctors, curseds, detraitors)
	for k, s in pairs(scores) do
		...
		scores[k].was_cursed = table.HasValue(curseds, k)
