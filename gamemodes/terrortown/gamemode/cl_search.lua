...
local function IconForInfoType(t, data)
	...
	if symbols then
		TypeToMat = {
			...
			eq_radar = "radar",
			eq_disg = "disguise",
			role = { [ROLE_TRAITOR] = "sym_tra", [ROLE_DETECTIVE] = "sym_det", [ROLE_MERCENARY] = "sym_mer", [ROLE_HYPNOTIST] = "sym_hyp", [ROLE_GLITCH] = "sym_gli", [ROLE_JESTER] = "sym_jes", [ROLE_PHANTOM] = "sym_pha", [ROLE_ZOMBIE] = "sym_zom", [ROLE_VAMPIRE] = "sym_vam", [ROLE_SWAPPER] = "sym_swa", [ROLE_ASSASSIN] = "sym_ass", [ROLE_KILLER] = "sym_kil", [ROLE_DOCTOR] = "sym_doc", [ROLE_CURSED] = "sym_cur", [ROLE_DETRAITOR] = "sym_der", [ROLE_INNOCENT] = "sym_inn" },
			c4 = "code",
			dmg = DmgToMat,
			wep = WeaponToIcon,
			head = "head",
...
function PreprocSearch(raw)
	...
	for t, d in pairs(raw) do
		...
		elseif t == "role" then
			...
			elseif d == ROLE_CURSED then
				search[t].text = T("search_role_c")
