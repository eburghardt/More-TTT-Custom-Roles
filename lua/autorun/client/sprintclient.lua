	...
	hook.Add("Think", "TTTSprint4Think", function()
		...
		elseif client:KeyDown(IN_FORWARD) and SprintKey() then
			...
			if GetRoundState() ~= ROUND_WAIT then
				if IsValid(client) and client:IsPlayer() and client:GetTraitor() or client:GetAssassin() or client:GetHypnotist() or client:GetVampire() or client:GetCursed() or client:GetZombie() or client:GetKiller() then
